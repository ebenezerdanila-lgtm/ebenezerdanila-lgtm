...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=700&size=18&duration=2600&pause=800&color=FF4444&center=true&vCenter=true&width=650&height=45&lines=3rd-Year+BSIS+%7C+Business+Analytics+%7C+WVSU-CICT;Turning+raw+data+into+real+decisions.;Building+systems+that+serve+real+communities.;Still+learning.+Still+building.+Still+becoming.)](https://github.com/ebenezerdanila-lgtm)
...
[![Mission](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=700&size=17&duration=3800&pause=1400&color=FF4444&center=true&vCenter=true&width=780&height=55&lines=Data+without+context+is+just+noise.;I+build+the+bridge+between+raw+information...;...and+the+decisions+that+move+communities+forward.)](https://github.com/ebenezerdanila-lgtm)
...
| 📐 Framework | IPCC AR5 HVRI · HLURB Guidelines |
...
| Layer | Technology |
|---|---|
| 🖥️ Framework | Streamlit · Custom "Deep Forest" UI |
| 📊 Visualizations | Folium · Plotly Sunburst · Tornado Charts · Heatmaps |
| 🗄️ Data | Kaggle — Global Sustainable Energy Dataset (152 nations) |
...
![github-snake](https://raw.githubusercontent.com/ebenezerdanila-lgtm/ebenezerdanila-lgtm/output/github-snake.svg)
...
| | |
|---|---|
| **🧠 Analytical Thinking** — Breaks complex, multi-variable problems into structured, data-driven solutions — not just answers, but frameworks. | **🤝 Team Collaboration** — Co-developed a full thesis system across multiple modules with a cross-functional group — coordinating design, data, and development. |
| **🔍 Attention to Detail** — Precision in data cleaning, schema design, and documentation. Errors don't hide for long. | **🌱 Continuous Learning** — Consistently expanding skills in Python, analytics pipelines, geospatial systems, and full-stack development. |
| **🗣️ Communication** — Translates statistical outputs and system logic into plain-language insights for non-technical stakeholders. | **🧩 Problem Solving** — Designed solutions for real-world LGU planning gaps — data problems with genuine human stakes. |
| **⚡ Critical Thinking** — Applied in selecting appropriate statistical methods, system architecture, and resolving edge cases under ambiguity. | **🚀 Leadership & Initiative** — Took ownership of system components, contributed proactively, and pushed deliverables forward without waiting to be asked. |
